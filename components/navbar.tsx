    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Desktop Right Menu */}
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/auth/signin" className="font-medium hover:text-primary transition-colors">
              Sign In
            </Link>
            <Link href="/auth/signup" className="font-medium text-white bg-primary px-4 py-2 rounded-md hover:bg-primary/90 transition-colors">
              Sign Up
            </Link>
            <DropdownMenu>
                ...
                <nav className="flex flex-col gap-4 pt-12">
                  ...
                  {moreItems.map((item, i) => (
                    <motion.div
                      ...
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ delay: (i + menuItems.length + 2) * 0.1 }}
                    >
                      <Link
                        href={item.href}
                        className="block py-3 text-lg font-medium text-white/90 hover:text-yellow-400 transition-colors"
