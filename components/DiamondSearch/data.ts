export const shapes = [
    { id: "round", label: "ROUND", image: "/LABON - Search Inventory.png" },
    { id: "oval", label: "OVAL", image: "/Oval.png" },
    { id: "pear", label: "PEAR", image: "/Pear.png" },
    { id: "marquise", label: "MARQUISE", image: "/Marquise.png" },
    { id: "heart", label: "HEART", image: "/Heart.png" },
    { id: "emerald", label: "EMERALD", image: "/Emerald.png" },
    { id: "cushion", label: "CUSHION", image: "/Cushion.png" },
    { id: "princess", label: "PRINCESS", image: "/Princess.png" },
    { id: "radiant", label: "RADIANT", image: "/Radiant.png" },
    { id: "asscher", label: "ASSCHER", image: "/Ascher.png" },
    { id: "others", label: "OTHERS", image: "/Others.png" },
  ];
  
  export const additionalShapes = [
    { id: "half_moon", label: "HALF MOON", image: "/Halfmoon.png" },
    { id: "baguette", label: "BAGUETTE", image: "/Baguette.png" },
    { id: "triangle", label: "TRIANGLE", image: "/Triangle.png" },
  ...
  export const cuts = ["ID", "EX", "VG", "GD", "FR", "N/A"];
  export const labs = ["IGI", "GIA", "GSI", "NONC", "GCAL", "NO-CERT"];
